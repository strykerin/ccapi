...
class Message {
 public:
  ...
  enum class Type {
    ...
    EXECUTION_MANAGEMENT_EVENTS_ACCOUNT_CONFIG_UPDATE,
    EXECUTION_MANAGEMENT_EVENTS_MARGIN_CALL,
  ...
  static std::string typeToString(Type type) {
    ...
    switch (type) {
      ...
      case Type::EXECUTION_MANAGEMENT_EVENTS_POSITION_UPDATE:
        ...
        break;
      case Type::EXECUTION_MANAGEMENT_EVENTS_ACCOUNT_CONFIG_UPDATE:
        output = "EXECUTION_MANAGEMENT_EVENTS_ACCOUNT_CONFIG_UPDATE";
        break;
      case Type::EXECUTION_MANAGEMENT_EVENTS_MARGIN_CALL:
        output = "EXECUTION_MANAGEMENT_EVENTS_MARGIN_CALL";
        break;
      ...
      case Type::REQUEST_FAILURE:
        ...
        break;
      case Type::REQUEST_OUTCOME_UNKNOWN:
        output = "REQUEST_OUTCOME_UNKNOWN";
        break;
